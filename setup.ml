...
(* OASIS_START *)
(* DO NOT EDIT (digest: 00f807fbae6abe0428107f1f6ce22a7a) *)
(*
...
let setup_t =
  {
               ...
               Executable
                 ({
                  ...
                  },
                   {
                      ...
                      bs_build_depends =
                        [
                           InternalLibrary "FPack";
                           InternalLibrary "testing";
     ...
     oasis_digest =
       Some "\155\r\180\169\228\023\217\251j\136i\211\194\213\149\019";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
