...
(* OASIS_START *)
(* DO NOT EDIT (digest: 9c91d0ca6d080844782cd4a6b285d6a7) *)
(*
...
# 6465 "setup.ml"
module OMakeFields = struct
(* # 22 "src/plugins/omake/OMakeFields.ml" *)
...
module OMakePlugin = struct
(* # 22 "src/plugins/omake/OMakePlugin.ml" *)
...
let setup_t =
  {
     ...
     build =
       OMakePlugin.BuildRuntime.main
         {OMakeFields.run_path = ""; extra_args = []};
     test = [];
     doc = [];
     install =
     ...
     clean =
       [
          OMakePlugin.BuildRuntime.clean
            {OMakeFields.run_path = ""; extra_args = []}
       ];
     clean_test = [];
     clean_doc = [];
     distclean =
       [
          OMakePlugin.BuildRuntime.distclean
            {OMakeFields.run_path = ""; extra_args = []}
       ];
     distclean_test = [];
     distclean_doc = [];
     package =
       {
          oasis_version = "0.4";
          ocaml_version = Some (OASISVersion.VGreaterEqual "4.04");
          version = "0.0";
          license = OASISLicense.OtherLicense "http://fig.ly/internal";
               ...
               Library
                 ({
                   ...
                   },
                   {
                      ...
                      lib_findlib_name = Some "functorpack";
               ...
               Executable
                 ({
                  ...
                  },
                   {
                      ...
                      bs_build_depends =
                        [InternalLibrary "FPack"; InternalLibrary "testing"];
                      bs_build_tools = [ExternalTool "omake"];
                      bs_interface_patterns =
                        [
                           {
                   ...
                   {exec_custom = false; exec_main_is = "Unittests.ml"})
            ];
          ...
          build_type = (`Build, "OMake", Some "0.4");
          build_custom =
            {
               pre_command = [(OASISExpr.EBool true, None)];
               post_command = [(OASISExpr.EBool true, None)]
            };
          install_type = (`Install, "OMake", Some "0.4");
          install_custom =
            {
               pre_command = [(OASISExpr.EBool true, None)];
               post_command = [(OASISExpr.EBool true, None)]
     ...
     oasis_digest =
       Some "\224K\207\197\014\169\145\131\169\172\235\190\139\024\191\140";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
